...
function getRelatedNews() {
    ...
    relatedNews = [{
        ...
        title: " لبنان.. دعوات لقطع الطرقات في اليوم الـ40 لانطلاق الاحتجاجات ",
        img: "img/new.jpg",
        newsContent: " اعلنت شركة أمازون الأميركية أنها تقاضي وزارة الدفاع (بنتاغون) بسبب استثنائها  من عطاء بقيمة عشرة مليارات دولار لتقديم ما يسمى خدمات 
        الحوسبة السحابية للوزارة، وهو العطاء الذي مُ نح لشركة مايكروسوفت ",
        path: "#"
    }, {
        title: " لبنان.. دعوات لقطع الطرقات في اليوم الـ40 لانطلاق الاحتجاجات ",
        img: "img/new.jpg",
        ...
        title: " لبنان.. دعوات لقطع الطرقات في اليوم الـ40 لانطلاق الاحتجاجات ",
        img: "img/new.jpg",
        newsContent: " اعلنت شركة أمازون الأميركية أنها تقاضي وزارة الدفاع (بنتاغون) بسبب استثنائها  من عطاء بقيمة عشرة مليارات دولار لتقديم ما يسمى خدمات   الحوسبة السحابية "
        للوزارة، وهو العطاء الذي مُ نح لشركة مايكروسوفت ",
        path: "#"
    }, {
        title: " لبنان.. دعوات لقطع الطرقات في اليوم الـ40 لانطلاق الاحتجاجات ",
        img: "img/new.jpg",
